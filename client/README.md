...
- **pubkey** - This is a public key which receives your node's tracking points. You can create one with the [keyholder software](https://github.com/inconsiderable/pass-trail/tree/master/keyholder).
