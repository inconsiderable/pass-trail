...
3. Install the [heart](https://github.com/inconsiderable/pass-trail/tree/main/heart)
4. Run the heart and issue a `newkey` command. Record the public key
5. Install the [client](https://github.com/inconsiderable/pass-trail/tree/main/client)
