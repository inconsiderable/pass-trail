...
$ go get -v github.com/inconsiderable/pass-trail/keyholder
$ go install -v github.com/inconsiderable/pass-trail/keyholder
```
...
```
$ keyholder -h
Usage of /home/passtrail/go/bin/keyholder:
  -peer string
